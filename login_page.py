...
class login_page:
    def __init__(self, root):
        ...
        self.frame1 = Frame(self.window, bg="blue")
        self.frame1.place(x=0, y=0, width=450, relheight = 1)

        label1 = Label(self.frame1, text="Login", font=("times new roman", 40, "bold"), bg="yellow", fg="red")
        label1.place(x=162, y=300)

        label2 = Label(self.frame1, text="Page", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1")
        label2.place(x=162, y=370)  # Adjust the y-coordinate to avoid overlap
